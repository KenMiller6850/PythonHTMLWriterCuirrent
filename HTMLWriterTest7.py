...
def addIndexRow(i):
    with a.tr():
        with a.td():   
            a.div(_t=dfindexes.iloc[i, dfindexes.columns.get_loc('IndexName')])
...
with open('C:\\Users\\akdmille\\Documents\\My Database Documentation\\FileTesting3\\User_databases\\NRTCUSTOMDB\\Tables\\filetestIndex.html', 'wb') as f:
